...
public class SimSettings {
	...
	// simulation window (will be initialized to the average execution time of all tasks (calculated in loadgenerator)
	public static double W;
	public static long maxI ; // maximum number of instructions / tasks
	public static double maxD ; // maximum data size / tasks 
	public static double alpha = 0.5;	// alpha and beta are user-defined coefficients
	public static double beta = 0.5;
	public static double LB = 0;
	public List<TaskProperty> taskList2 = new ArrayList<TaskProperty>();

	public static double maxW ;
	public static double incr = 6;
	
	
	public static final double CLIENT_ACTIVITY_START_TIME = 0;  // default value was 10
