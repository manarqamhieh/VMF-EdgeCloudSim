...
public class TaskProperty {
	...
	public TaskProperty(double _startTime, int _mobileDeviceId, int _taskType, int _pesNumber, long _length,
			long _inputFileSize, long _outputFileSize) {
		...
		//System.out.println(outputFileSize);
		
		
		// System.out.print("\n\n _mobileDeviceId: "+_mobileDeviceId+" --- startTime:
		// "+startTime+" --- taskType: "+taskType);
		// System.out.print("\n inputFileSize: "+inputFileSize+" --- outputFileSize:
		// "+outputFileSize+" --- length: "+length);
		// System.out.print("\n pesNumber: "+pesNumber+"\n");
...
//		System.out.print("\n\n _mobileDeviceId: "+_mobileDeviceId+" --- startTime: "+_startTime+" --- taskType: "+taskType);
//		System.out.print("\n inputFileSize: "+inputFileSize+" --- outputFileSize: "+outputFileSize+" --- length: "+length);
//		System.out.print("\n pesNumber: "+pesNumber+"\n");
	...
	public double getExecutionTimeonMobile() {
		return(double)length /  SimSettings.getInstance().getMipsForMobileVM();
		
	}
	public double getExecutionTimeonCloud() {
		return (double)length /  SimSettings.getInstance().getMipsForCloudVM();
		
	}
	@Override
    public String toString() {
        return String.format("TaskProperty {ID = %d\tLength = %d\tPi = %f\n}", mobileDeviceId, length, Pi);
    }
}
