...
public class DefaultMobileDeviceManager extends MobileDeviceManager {
	...
	public void submitTask(TaskProperty edgeTask) {
		NetworkModel networkModel = SimManager.getInstance().getNetworkModel();
		//System.out.println("DefaultMobileDeviceManager.submitTask() ----- here");
		//create a task
		Task task = createTask(edgeTask);
		
		//\System.out.println("submitTask: "+edgeTask +" time "+CloudSim.clock());
	...
	private void submitTaskToVm(Task task, double delay, int datacenterId) {
		...
		//System.out.println("task "+task.getAssociatedHostId()+" === datacenterId "+datacenterId+"  -- delay "+delay);
		int vmType = 0;
